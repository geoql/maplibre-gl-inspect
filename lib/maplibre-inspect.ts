...
MaplibreInspect.prototype.render = () => {
...
MaplibreInspect.prototype._onSourceChange = (e) => {
...
MaplibreInspect.prototype._onStyleChange = () => {
...
MaplibreInspect.prototype._onRightClick = () => {
  if (
...
MaplibreInspect.prototype._onMousemove = (e) => {
  if (this._showInspectMap) {
...
MaplibreInspect.prototype.onRemove = () => {
